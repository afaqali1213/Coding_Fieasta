...
#   8) Product Class for E-Commerce:
class Product:
    ...
    def sold_products(self):
        number_of_products_sold = int(input("Enter the number of products sold: "))
        print(f"The revenue generated after selling {number_of_products_sold} products is {number_of_products_sold*self.price}$")
        self.stock -= number_of_products_sold
        print("Available stock: ",self.stock)
    
    def restock(self):
        product_quantity = int(input("Enter the products quantity to add in stock: "))
